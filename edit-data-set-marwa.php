      ...
      <div class="container-fluid">
        <div class="card">
          ...
          <div class="card-body p-3">
            <form action="proses/proses-produk-set-marwa.php" method="POST" enctype="multipart/form-data">
              <?php
                //tangkap URL dengan $_GET
                $id = $_GET['edit-set-marwa'];
                $key = "KM@2024?SET";
                $ide = decrypt($id, $key);
                // Menampilkan data
                $sql = "SELECT 
                        ...
                        LEFT JOIN tb_produk_grade gr ON (prs.id_grade = gr.id_grade)
                ...
                $img = $row['gambar'];
                $no_img = $row["gambar"] == "" ? "gambar/upload-produk-set-marwa/no-image.png" : "gambar/upload-produk-set-marwa/$img";
              ?>
              <?php  
                if($cek_data > 0){
                  ?>
