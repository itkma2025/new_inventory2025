            ...
            <div class="container">
                <div class="card">
                    <div class="card-body p-3">
                        ...
                        ?>
                        <form action="proses/invoice-reupload-ecat-pl.php" method="post" enctype="multipart/form-data" id="form">
                            ...
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control bg-light" value="<?php echo $data['no_inv_pl']; ?>" readonly>
                                </div>
                            </div>
                            <?php  
