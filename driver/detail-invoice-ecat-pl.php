    ...
    <main id="main" class="main">
        <section>
            <?php
                ...
                require_once "query/detail-inv-ecat-pl.php";
            ?>
                                ...
                                <div class="col-7">
                                    <?php  
                                        ...
                                        while($detail_spk_trim = mysqli_fetch_array($spk_trim)){
                                            $no_spk = $detail_spk_trim['no_spk_pl'];
                                            $tgl_pesanan = date("d/m/Y", strtotime($detail_spk_trim['tgl_pesanan_pl']));
                                            $no_inv_pl = $detail_spk_trim['no_inv_pl'];
                                            $tgl_inv_pl = date("d/m/Y", strtotime($detail_spk_trim['tgl_inv_pl']));
                    ...
                    <div class="table-responsive">
                        <div class="text-start mb-3">
                            ...
                            <?php  
                                ...
                                if($jenis_reject == '1'){
                                    ?>
                                         <a id="btnDiterima" href="form-reupload-ecat-pl.php?id=<?php echo $id_inv ?>" class="btn btn-secondary mb-2"><i class="bi bi-send"></i> Reupload Bukti Kirim</a>
                                    <?php
                                } else if ($jenis_reject == '2'){
                                    ?>
                                         <a id="btnDiterima" href="form-diterima-ecat-pl.php?id=<?php echo $id_inv ?>" class="btn btn-secondary mb-2"><i class="bi bi-send"></i> Diterima</a>
                                    <?php
                                } else {
                                    ?>
                                        <a id="btnDiterima" href="form-diterima-ecat-pl.php?id=<?php echo $id_inv ?>" class="btn btn-secondary mb-2"><i class="bi bi-send"></i> Diterima</a>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-nowrap"><?php echo $data_produk['no_spk_pl']; ?></td>
