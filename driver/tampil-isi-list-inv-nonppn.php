...
<head>
    ...
    <style type="text/css">
        ...
        video, canvas {
            width: 100%; /* Perhitungan lebar dengan padding */
            height: auto;
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-body">
                    <form action="proses/proses-invoice-nonppn-diterima.php" method="POST" enctype="multipart/form-data" id="uploadForm">
                        ...
                        <div class="mb-3">
                            ...
                            <button id="upload-bukti" type="button">Upload Bukti Terima</button>
                        </div>
                        <div class="mb-3">
