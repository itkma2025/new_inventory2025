...
if (isset($_POST['diterima'])) {
    ...
    if ($diterima_oleh == 'Customer') {
        ...
        try {
            ...
            // Query untuk update status_transaksi di inv_nonppn
            $query_update_inv = mysqli_query($connect, "UPDATE inv_nonppn SET status_transaksi = 'Diterima' WHERE id_inv_nonppn = '$id_inv_decrypt'");
        ...
        try {
            ...
            // Query untuk update status_transaksi di inv_nonppn
            $query_update_inv = mysqli_query($connect, "UPDATE inv_nonppn SET ongkir = '$ongkir', status_transaksi = 'Dikirim' WHERE id_inv_nonppn = '$id_inv_decrypt'");
