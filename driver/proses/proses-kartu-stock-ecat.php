...
if (isset($_POST['simpan'])) {
        ...
        if ($token_csrf != "") {
            if ($date_now > $exp_token) {
                ...
                try {
                    ...
                    $simpan_data_kartu_stock = "INSERT INTO kartu_stock_ecat 
                    ...
                    $simpan_history_kartu_stock = "INSERT INTO kartu_stock_ecat_history
    ...
    if ($token_csrf != "") {
        if ($date_now > $exp_token) {
            ...
            try {
                ...
                // Eksekusi query SQL pertama
                $edit_in = "UPDATE kartu_stock_ecat SET keterangan = '$keterangan', qty_in = '$qty' WHERE id_kartu_stock = '$id_kartu_stock_decrypt'";
    ...
    if ($token_csrf != "") {
        if ($date_now > $exp_token) {
            ...
            try {
                ...
                // Eksekusi query SQL pertama
                $edit_out = "UPDATE kartu_stock_ecat SET keterangan = '$keterangan', qty_out = '$qty' WHERE id_kartu_stock = '$id_kartu_stock_decrypt'";
    ...
    try {
        ...
        // Eksekusi query SQL pertama
        $hapus = $connect->query("DELETE FROM kartu_stock_ecat WHERE id_kartu_stock = '$id_kartu_stock_decrypt'");
        if (!$hapus) {
            throw new Exception("Kesalahan dalam eksekusi simpan data kartu stock: " . $connect->error);
        }
