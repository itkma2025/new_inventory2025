...
if (isset($_POST['diterima'])) {
    ...
    if ($diterima_oleh == 'Customer') {
        ...
        try {
            ...
            // Query untuk update status_transaksi di inv_bum
            $query_update_inv = mysqli_query($connect, "UPDATE inv_bum SET status_transaksi = 'Diterima' WHERE id_inv_bum = '$id_inv_decrypt'");
        ...
        try {
            ...
            // Query untuk update status_transaksi di inv_bum
            $query_update_inv = mysqli_query($connect, "UPDATE inv_bum SET ongkir = '$ongkir', status_transaksi = 'Dikirim' WHERE id_inv_bum = '$id_inv_decrypt'");
