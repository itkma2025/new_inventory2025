                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center text-nowrap" style=" vertical-align: middle;">
                                            <?php
                                                if($jenis_pengiriman = 'Driver' && $jenis_penerima == '' || $approval == '1'){
                                                    ?>
                                                        <a href="detail-invoice.php?id=<?php echo $id_inv_encrypt ?>&&jenis_inv=<?php echo $data['jenis_inv']?>" class="btn btn-primary btn-sm"><i class="bi bi-arrow-repeat"></i> Proses</a>
                                                    <?php
                                        ...
                                        <td class="text-nowrap text-center">
                                            <?php echo $data['no_inv']; ?><br><?php echo date('H:i:s', strtotime($data['created_date'])) ?><br>(<?php echo $data['tgl_pesanan'] ?>)
                                        </td>
