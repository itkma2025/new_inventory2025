                        ...
                        <div class="table-responsive mt-3">
                            <table class="table table-striped table-bordered" id="table2">
                                ...
                                <tbody>
                                    ...
                                    $key = "Driver2024?";
                                    $no = 1;
                                    $query = mysqli_query($connect, $sql_waiting_verif) or die(mysqli_error($connect));
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center text-nowrap" style=" vertical-align: middle;">
                                            <a href="detail-invoice-menunggu-verif.php?id=<?php echo $id_inv_encrypt ?>&&jenis_inv=<?php echo $data['jenis_inv']?>" class="btn btn-primary btn-sm"><i class="bi bi-eye"></i> Detail Invoice</a>
                                        </td>
