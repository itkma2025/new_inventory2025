                ...
                <div class="card">
                    <div class="card-body p-3">
                        ...
                        <?php  
                            ...
                            include "query/menunggu-verif-invoice-ecat.php";
                        ...
                        <div class="table-responsive mt-3">
                            <table class="table table-striped table-bordered" id="table2">
                                ...
                                <tbody>
                                    ...
                                    $key = "Driver2024?";
                                    $no = 1;
                                    $query = mysqli_query($connect_ecat, $sql_waiting_verif) or die(mysqli_error($connect_ecat));
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center text-nowrap" style=" vertical-align: middle;">
                                            <a href="detail-invoice-menunggu-verif-ecat.php?id=<?php echo $id_inv_encrypt ?>" class="btn btn-primary btn-sm"><i class="bi bi-eye"></i> Detail Invoice</a>
                                        </td>
...
$(document).ready(function() {
    ...
    $("#ecat-pl").click(function() {
        window.location.href = "lmenunggu-verif-invoice-ecat-pl.php";
    });
});
</script>