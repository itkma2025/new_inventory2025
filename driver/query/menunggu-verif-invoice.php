<?php 
    ...
    $sql_waiting_verif = "SELECT
                        ...
                        WHERE sk.dikirim_driver = '$id_user' AND COALESCE(nonppn.status_transaksi, ppn.status_transaksi, bum.status_transaksi) = 'Diterima' AND 
                        STR_TO_DATE(sk.tgl_kirim, '%d/%m/%Y') <= CURDATE() AND sk.status_review = '0'
                        GROUP BY no_inv ORDER BY no_inv ASC";
?>