                ...
                <div class="card">
                    <div class="card-body p-3">
                        <?php
                            ...
                            if($jenis_inv == "nonppn"){
                                require_once "query/query-form-diterima-nonppn.php";
                                $data = mysqli_fetch_array($detail);
                                $href = "proses/invoice-nonppn-diterima.php";
                            } else if($jenis_inv == "ppn"){
                                require_once "query/query-form-diterima-ppn.php";
                                $data = mysqli_fetch_array($detail);
                                $href = "proses/invoice-ppn-diterima.php";
                            } else if($jenis_inv == "bum"){
                                require_once "query/query-form-diterima-bum.php";
                                $data = mysqli_fetch_array($detail);
                                $href = "proses/invoice-bum-diterima.php";
                            } else {
                        ...
                        ?>
                        <form action="<?php echo $href ?>" method="post" enctype="multipart/form-data" id="form">
                            ...
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control bg-light" value="<?php echo $data['no_inv']; ?>" readonly>
                                </div>
