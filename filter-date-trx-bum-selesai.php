                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center text-nowrap">
                            <a href="detail-produk-selesai.php?jenis=bum&&id=<?php echo encrypt($data['id_inv_bum'], $key_global) ?>" class="btn btn-primary btn-sm mb-2"><i class="bi bi-eye-fill"></i> </a>
                        </td>
                    </tr>
                    <?php $no++ ?>
                <?php } ?>
