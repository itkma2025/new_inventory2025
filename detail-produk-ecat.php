...
<body>
    <?php
        ...
        $img = "";
        if ($data['gambar'] && file_exists("gambar/upload-produk-ecat/" . $data['gambar'])) {
            $img = "gambar/upload-produk-ecat/" . $data['gambar'];
        } else {
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="d-flex justify-content-center">
                            <?php  
                                $sql_produk_reg = $connect->query("SELECT id_produk, qty_in, qty_out FROM kartu_stock_ecat WHERE id_produk ='$id_produk'");
                                $total_qty_in = 0;
                                $total_qty_out = 0;
                                $stock_tersedia = 0;
                    ...
                    <div class="col-md-6">
                        <div class="d-flex justify-content-end mt-4">
                            <?php  
                                ...
                                $session_url = "";
                                if ($role == "Driver") {
                                    $session_url = "driver/kartu-persediaan-barang.php?jenis_produk=ecat&id=" . $id;
                                } else {
                                    $session_url = "kartu-persediaan-barang.php?jenis_produk=ecat&id=" . $id;
                                }
