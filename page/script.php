...
<script type="text/javascript">
    flatpickr("#date", {
        dateFormat: "d/m/Y",
        defaultDate: "today" // Menampilkan tanggal hari ini secara otomatis
    });
</script>
<!-- end date picker -->
...
<!-- Ajax notifikasi -->
<script src="ajax-js/notifikasi-badge.js"></script>
<!-- <script src="ajax-js/notifikasi-today.js"></script> -->
<script src="ajax-js/notifikasi-today-earlier.js"></script>
