<?php
    ...
    $query_total_sudah_review_reg = "SELECT COUNT(*) AS total_sudah_review_reg
                                        FROM (
                                            SELECT DISTINCT
    ...
    $query_total_sudah_review_ecat = "SELECT COUNT(*) AS total_sudah_review_ecat
                                    FROM (
                                        SELECT DISTINCT
    ...
    $query_total_sudah_review_ecat_pl = "SELECT COUNT(*) AS total_sudah_review_ecat_pl
                                            FROM (
                                                SELECT DISTINCT
    ...
    $result_sudah_review_reg = $connect->query($query_total_sudah_review_reg);
    $row_sudah_review_reg = $result_sudah_review_reg->fetch_assoc();
    $total_data_sudah_review_reg = $row_sudah_review_reg['total_sudah_review_reg'];

    $result_sudah_review_ecat = $connect_ecat->query($query_total_sudah_review_ecat);
    $row_sudah_review_ecat = $result_sudah_review_ecat->fetch_assoc();
    $total_data_sudah_review_ecat = $row_sudah_review_ecat['total_sudah_review_ecat'];

    $result_sudah_review_ecat_pl = $connect_ecat->query($query_total_sudah_review_ecat_pl);
    $row_sudah_review_ecat_pl = $result_sudah_review_ecat_pl->fetch_assoc();
    $total_data_sudah_review_ecat_pl = $row_sudah_review_ecat_pl['total_sudah_review_ecat_pl'];
?>
