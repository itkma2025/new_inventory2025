<?php  
   ...
   $sql_detail = "SELECT DISTINCT
    ...
    $sql_driver = " SELECT DISTINCT
                        ...
                        status_kirim_nonppn.jenis_ongkir AS jenis_ongkir,
                    ...
                    LEFT JOIN inv_penerima penerima ON nonppn.id_inv_nonppn = penerima.id_inv
    ...
    $sql_driver_rev = " SELECT DISTINCT 
                            ...
                            sk.ongkir,
                            sk.free_ongkir,
                            sk.dikirim_driver AS id_driver,
                            sk.dikirim_oleh,
                            sk.diambil_oleh,
                            sk.penanggung_jawab,
                            sk.alasan,
