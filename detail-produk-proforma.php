...
<body>
    ...
    <main id="main" class="main">
       ...
       <section>
                        ...
                        if ($role == "Super Admin" || $role == "Admin Penjualan") {
                            ?>
                                <div class="text-center mt-3 mb-3">
                                    <button class="btn btn-info btn-md btn-mobile" data-bs-toggle="modal" data-bs-target="#editPelanggan"><i class="bi bi-pencil"></i> Edit Data Detail</button>
                                </div>
                            <?php
                        }
                        require_once 'modal/edit-data-inv.php'; 
                    ?>
                </div>
                <div class="row mt-3">
                    <div class="col-md-10">
                        <div class="text-start">
                            ...
                            <?php 
                                if ($role == "Super Admin" || $role == "Admin Penjualan") {
                                    ?>
                                        <button class="btn btn-info btn-detail mb-2 btn-mobile" data-bs-toggle="modal" data-bs-target="#ubahKat">
                                            <i class="bi bi-arrow-left-right"></i> Ubah Kategori Invoice
                                        </button>
                                        <a href="#" class="btn btn-primary btn-detail mb-2 btn-mobile" data-bs-toggle="modal" data-bs-target="#addSpk">
                                            <i class="bi bi-plus-circle"></i> Tambah SPK
                                        </a>
                                    <?php
                                    
                                    if ($total_data_status_trx_0 == 0) {
                                        ?>
                                                <button class="btn btn-warning btn-detail mb-2 btn-mobile" data-bs-toggle="modal" data-bs-target="#Dikirim">
                                    ...
                                    if($status_cb == '1'){
                                        ?>
                                            <button class="btn btn-info btn-detail mb-2 btn-mobile" data-bs-toggle="modal" data-bs-target="#ubahJenisCb">
                                                <i class="bi bi-send"></i> Ubah Jenis CB
                                            </button>
                                        <?php
                                    }
                                }
                ...
                <div class="col-xl-12 p-3">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered" id="table3">
                                                ...
                                                ?>
                                                    <td class="text-center text-nowrap">
                                                        <?php
                                                            if ($total_data_status_trx_1 != 0) {
                                                                ?>
                                                                    <button class="btn btn-warning btn-sm" id="editProduk" data-bs-target="#modalEditProduk" data-idtrx="<?php echo encrypt($data_trx['id_transaksi'], $key_global) ?>" data-idinv="<?php echo encrypt($id_inv, $key_global) ?>" data-jenisinv = "<?php echo $jenis_inv ?>" data-kat="<?php echo $data_inv['kategori_inv'] ?>" data-jeniscb ="<?php echo  $cb_per_barang ?>" data-cs='<?php echo encrypt($id_cs, $key_global); ?>' data-noinv='<?php echo encrypt($data_inv['no_inv'], $key_global); ?>'><i class="bi bi-pencil"></i></button>
                                                                <?php
                            ...
                            <?php require_once 'modal/edit-produk-proforma.php' ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2 mb-1">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control text-end harga_produk mobile-text" name="harga_produk[]" value="<?php echo number_format($data_cek_harga['harga'],0,'.','.') ?>" oninput="formatNumber(this)" data-index="<?php echo encrypt($id_produk, $key_global); ?>"  required>
                                    <span class="input-group-text" id="referensiHarga"  title="Lihat Referensi Harga Produk" data-bs-toggle="modal" data-bs-target="#referensiHargaProduk" data-id='<?php echo encrypt($id_produk, $key_global); ?>' data-cs='<?php echo encrypt($id_cs, $key_global); ?>' data-noinv='<?php echo encrypt($data_inv['no_inv'], $key_global); ?>'>
                            ...
                            <?php if ($total_cek_harga != 0): ?>
                                ...
                                <div class="col-sm-<?php echo $col_size; ?> mb-1">
                                    <div class="input-group">
                                        <input type="text" class="form-control bg-light text-end mobile-text" name="qty[]" value="<?php echo number_format($data_cek_harga['qty'],0,'.','.') ?>" readonly>
            ...
            <?php require_once 'modal/ubah-kategori-proforma.php';  ?>
            <!-- End modal Input SPdisc Inv -->
        </section>
        <!-- Modal Referensi Harga -->
        <?php require_once 'modal/referensi-harga-produk.php';  ?>
        <!-- End modal  Referensi Harga -->
    </main><!-- End #main -->
    <!-- Modal Add SPK -->
    <?php require_once 'modal/add-spk-proforma.php';  ?>
    <!-- End modal Add SPK -->
...
<!-- Modal Dikirim -->
<?php require_once 'modal/dikirim-proforma.php';  ?>
<!-- End modal Dikirim -->

<!-- Modal Dikirim -->
<?php require_once 'modal/ubah-jenis-cb-proforma.php';  ?>
<!-- End modal Dikirim -->
