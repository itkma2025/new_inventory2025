...
if (isset($_POST['id'])) {
    ...
    $sql_bukti = "SELECT 
                ...
                LEFT JOIN inv_pl pl ON (ibt.id_inv_ecat = pl.id_inv_pl)
    ...
    if ($data_bukti) {
        $created_by = $data_bukti['user_created'];
        ...
        $path_ecat = "http://localhost:8082/image-history-ecat-pl.php?file=$view_image";
        $img = "";
        if(!empty($nama_driver)){
            if($gambar && file_exists("../gambar/bukti_kirim/pl/" . $nama_driver . "/" . $gambar)){
                $img = $path;
            } else {
        ...
        <div class="card mb-3 p-2">
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-center">
                    <div>
                        <a href="proses/review-ecat.php?id=<?php echo $_POST['id'] ?>&&action=approval" class="btn btn-primary btn-md"><i class="bi bi-check-circle"></i> Approve</a>
                        <a href="proses/review-ecat.php?id=<?php echo $_POST['id'] ?>&&action=reject" class="btn btn-danger btn-md reject-data"><i class="bi bi-x-circle"></i> Reject</a>
                    </div>
                </div>
            </div>
        </div>
