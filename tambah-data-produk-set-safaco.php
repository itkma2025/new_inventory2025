      ...
      <div class="container-fluid">
        <div class="card">
          ...
          <div class="card-body p-3">
            <form action="proses/proses-produk-set-safaco.php" method="POST" enctype="multipart/form-data">
              <?php 
                  $UUID = generate_uuid();
              ?>
              <input type="hidden" class="form-control" name="id_set_safaco" value="SET_SKM_<?php echo $UUID; ?>">
              <div class="mb-3">
                <div class="row">
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="nama_set_safaco" required>
              </div>
              <div class="mb-3">
                <div class="row">
              ...
              <div class="mb-3">
                ...
                <div class="mb-3 pt-3 text-end">
                    <button type="submit" name="simpan-set-safaco" class="btn btn-primary btn-md"><i class="bx bx-save"></i> Simpan Data</button>
                    <a href="data-produk-set-safaco.php" class="btn btn-secondary btn-md"><i class="bi bi-x"></i> Tutup</a>
                </div>
            </form>
        </div>  
    </section>
