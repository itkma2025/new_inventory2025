        ...
        <div class="card">
          <div class="card-body p-3">
            ...
            <ul class="nav nav-pills mb-3 mt-3">
              <li class="nav-item">
                <a href="stock-produk-ecat.php" class="nav-link active">Produk Satuan</a>
              </li>
              <li class="nav-item" >
                <a href="stock-produk-set-ecat.php" class="nav-link">Produk Set</a>
              </li>
            </ul>
              ...
              <table class="table table-striped table-bordered" id="table1">
                ...
                <tbody>
                  ...
                  while ($data = mysqli_fetch_array($query)) {
                    $id_stock = encrypt($data['id_stock_prod_ecat'], $key_global);
