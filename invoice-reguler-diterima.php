                                        ...
                                        <tbody>
                                            ...
                                            $query = mysqli_query($connect, $sql);
                                                while ($data = mysqli_fetch_array($query)) {
                                                    $id_nonppn_encrypt = encrypt($data['id_inv_nonppn'], $key_global);
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center text-nowrap">
                                                        <a href="detail-produk-diterima.php?jenis=nonppn&&id=<?php echo urlencode($id_nonppn_encrypt); ?>" class="btn btn-primary btn-sm mb-2" title="Lihat Produk"><i class="bi bi-eye-fill"></i></a>
                                                    </td>
                                                </tr>
                                                <?php $no++ ?>
                                            <?php } ?>
                                ...
                                <form id="invoiceForm" name="proses" method="POST">
                                    ...
                                    <table class="table table-bordered table-striped" id="table3">
                                        ...
                                        <tbody>
                                            ...
                                            $query = mysqli_query($connect, $sql);
                                                while ($data = mysqli_fetch_array($query)) {
                                                    $id_ppn_encrypt = encrypt($data['id_inv_ppn'], $key_global);
                                            ?>
                                                <tr>
                                                    <td class="text-center text-nowrap"><?php echo $no; ?></td>
                                                    <td class="text-center text-nowrap"><?php echo $data['no_inv'] ?></td>
                                                    ...
                                                    <td class="text-center text-nowrap">
                                                        <a href="detail-produk-diterima.php?jenis=ppn&&id=<?php echo urlencode($id_ppn_encrypt); ?>" class="btn btn-primary btn-sm mb-2" title="Lihat Produk"><i class="bi bi-eye-fill"></i> </a>
                                                    </td>
                                                </tr>
                                                <?php $no++ ?>
                                            <?php } ?>
