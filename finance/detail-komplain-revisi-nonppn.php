    ...
    <main id="main" class="main">
        ...
        <section>
            <?php  
                ...
                $cek_status_cancel = $connect->query("SELECT id_inv_nonppn, status_transaksi, total_inv FROM inv_nonppn WHERE id_inv_nonppn = '$id_inv'");
                    ...
                    <div class="row mb-3">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="detail-komplain-nonppn.php?id=<?php echo encrypt($id, $key_spk) ?>"
