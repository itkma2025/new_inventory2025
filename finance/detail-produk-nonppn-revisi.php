            ...
            <div class="card">
                <div class="card-body p-3">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card-body">
                                <a href="detail-invoice-customer.php?sort_data=tahun_ini&cs=<?php echo $id_cs ?>" class="btn btn-warning mb-3">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3" id="jenis_driver" style="display: none;">
                        ...
                        <select id="pengirim" name="pengirim" class="form-select">
                            <option value="">Pilih...</option>
                            <?php
                            $sql_driver = mysqli_query($connect, "SELECT us.id_user_role, us.id_user, us.nama_user, rl.nama_role FROM $database2.user AS us JOIN user_role rl ON (us.id_user_role = rl.id_user_role) WHERE rl.nama_role = 'Driver'");
