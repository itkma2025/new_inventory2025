      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body p-3">
            <button class="btn btn-primary btn-md" data-bs-toggle="modal" data-bs-target="#modal1" style="margin-left: 12px;"><i class="bi bi-plus-circle"></i> Tambah data supllier</button>
