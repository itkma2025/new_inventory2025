                                ...
                                <td class="text-center">
                                    <?php  
                                        if ($id_inv_substr == 'NON') {
                                            ?>
                                                <a href="detail-komplain-nonppn.php?id=<?php echo encrypt($id_komplain, $key_spk) ?>" class="btn btn-primary btn-sm" title="Detail"><i class="bi bi-eye"></i></a>
                                            <?php
                                        } else  if ($id_inv_substr == 'PPN') {
                                            ?>
                                                <a href="detail-komplain-ppn.php?id=<?php echo encrypt($id_komplain, $key_spk) ?>" class="btn btn-primary btn-sm" title="Detail"><i class="bi bi-eye"></i></a>
                                            <?php
