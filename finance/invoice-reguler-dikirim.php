                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center text-nowrap">
                                                        <a href="detail-produk-dikirim.php?jenis=nonppn&&id=<?php echo encrypt($data['id_inv_nonppn'], $key_global) ?>" class="btn btn-primary btn-sm mb-2" title="Lihat Produk"><i class="bi bi-eye-fill"></i></a>
                                                    </td>
                                                </tr>
                                                <?php $no++ ?>
                                            <?php } ?>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center text-nowrap">
                                                        <a href="detail-produk-dikirim.php?jenis=ppn&&id=<?php echo encrypt($data['id_inv_ppn'], $key_global) ?>" class="btn btn-primary btn-sm mb-2" title="Lihat Produk"><i class="bi bi-eye-fill"></i> </a>
                                                    </td>
                                                </tr>
                                                <?php $no++ ?>
                                            <?php } ?>
