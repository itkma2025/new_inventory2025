<?php
    ...
    $page2 = '';
    $halaman_sebelumya = '';
    // Periksa apakah parameter 'bill' ada dalam query string
    if (isset($_GET['bill'])) {
        $page = 'list-tagihan';
        $page2 = 'tagihan-penjualan';
        $halaman_sebelumya = 'detail-bill.php?id=' . $_GET['bill'] ;
    } else {
        $page = 'invoice';
        $page2  = 'penjualan';
        $halaman_sebelumya = 'finance-inv.php?date_range=monthly';
    }
                ...
                <div class="card-body p-3">
                    <div class="table-responsive">
                        <div class="text-start mb-3">
                            <a href="<?php echo $halaman_sebelumya ?>" class="btn btn-warning btn-detail mb-2">
