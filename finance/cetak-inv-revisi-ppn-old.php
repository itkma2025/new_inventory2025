...
<body>
    <div style="text-align: center; margin-top: 20px; margin-bottom:20px;" id="printButton">
        <a style="text-decoration: none;" href="#">
            <button class="button button-outline active" id="ppn-old">
                <i class="fas fa-file"></i> PPN Lama
            </button>
        </a>
        <a style="text-decoration: none;" href="cetak-inv-revisi-ppn-new.php?id=<?php echo $_GET['id'] ?>&&id_komplain=<?php echo $_GET['id_komplain']?>">
    ...
    $id = htmlspecialchars($_GET['id_komplain']);
    $sql = "SELECT 
            ppn.*, 
    ...
    ?>
      <div style="text-align: center;">
            <button id="print" class="print-button-new">
    ...
    <div class="invoice">
        ...
        <div class="invoice-payment">
            ...
            $ppn = 11;
            $sp_disc = isset($data_inv['sp_disc']) && is_numeric($data_inv['sp_disc']) ? floatval($data_inv['sp_disc']) / 100 : 0; 
            $ongkir = floatval($data_inv['ongkir']);

            // Perhitungan Sub total - Spesial Discount
            $sub_total_spdisc = round(floatval($sub_total_tampil) * (1 - $sp_disc)); 
            $nominal_sp_disc = round(floatval($sub_total_tampil) * $sp_disc); 

            // Perhitungan Nominal PPN
            $nominal_ppn = round(floatval($sub_total_tampil) * (floatval($ppn) / 100));
            ...
            <div class="col-payment-2">
                ...
                <div class="amount">
                    ...
                    ?>
                    <?php echo number_format($sub_total_spdisc, 0, '.', '.') ?>
                    <br>
