        ...
        <div class="card">
          <div class="card-body p-3">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="margin-left: 13px;">
              ...
              <li class="nav-item" role="presentation">
                <a href="list-tagihan-pembelian-lunas.php?date_range=year" class="nav-link">Tagihan Lunas</a>
              </li>
            </ul>
            ...
            <div class="table-responsive">
                <table class="table table-responsive table-striped" id="table2">
                  ...
                  <tbody>
                    <?php  
                      include "query/list-tagihan-pembelian.php";
                      $total_bayar = 0;
                      while($data_pembayaran = mysqli_fetch_array($sql_pembayaran)){
                        $id_inv_pembelian = $data_pembayaran['id_inv_pembelian'];
                        ...
                        if($sisa_tagihan == 0){
                          $update_status_lunas = $connect->query("UPDATE inv_pembelian_lokal SET status_lunas = '1' WHERE id_inv_pembelian = '$id_inv_pembelian'");
                        }
                    ...
                    <tr>
                      ...
                      <td class="text-end"><?php echo number_format($sisa_tagihan,0,'.','.') ?></td>
