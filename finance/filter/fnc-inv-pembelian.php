<div class="row">
    ...
    <div class="col-sm-3">
        <div class="p-3">
            ...
            <br>
            <div class="btn-group">
                <button type="button" class="btn btn-primary dropdown-toggle min-width" data-bs-toggle="dropdown" aria-expanded="false">
                <?php
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <form action="" method="GET" class="form-group newsletter-group" id="dateForm">
                        ...
                        <a href="finance-inv-pembelian.php?date_range=year" name="tampilkan" class="custom-dropdown-item dropdown-item rounded bg-danger text-white" id="resetLink">Reset</a>
                    </form>
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            endDateInput.addEventListener('change', () => {
                                ...
                                const newUrl = `finance-inv-pembelian.php?${queryParams.toString()}`;
