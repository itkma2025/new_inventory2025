...
<body>
            ...
            <div class="card p-3">
                <div class="row" style="margin-left: 2px;">
                    <div class="col-md-3 mb-2">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahDataBank"><i class="bi bi-plus-circle"></i> Tambah Data Bank Supplier</button>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-striped" id="table2">
                        <thead>
                            <tr class="text-white" style="background-color: navy;">
                                ...
                                <th class="text-center text-nowrap p-3" style="width: 350px;">Nama Supplier</th>
    ...
    <div class="modal fade animate__animated animate__rollIn" id="tambahDataBank" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
