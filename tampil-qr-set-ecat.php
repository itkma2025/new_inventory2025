            ...
            ?>
                ...
                <script>
                    ...
                    Swal.fire({
                        ...
                        window.location.href = "data-produk-set-ecat.php";
                    });
                    });
                </script>
            <?php
        ...
        <section class="section dashboard">
            <?php  
                ...
                $sql = "SELECT 
                        ...
                        LEFT JOIN qr_link_set_ecat qr ON (tpse.id_set_ecat = qr.id_set_qr)
            ...
            <?php  
                if ($cek_data > 0) {
                    ...
                    $img = $data['qr_img'];
                    $no_img = $data["qr_img"] == "" ? "gambar/QRcode-set-ecat/no-image.png" : "gambar/QRcode/$img";
                    ?>
                        <div id="content">
                            <div class="row">
                                <div class="col-10">     
                                    <p class="p-2" style="font-weight: bold; font-size: 26px; margin-bottom: 0px !important;"><?php echo $data['nama_set_ecat']; ?> (<?php echo $data['nama_merk']; ?>) </p>
                                    <div class="row">
                                        <div class="ms-2" style="font-size: 20px;">Kemenkes RI AKL : <?php echo $data['no_izin_edar'] ?></div>
                                    </div>  
                                </div>
                                <div class="col-2 text-end">
                                    <img src="gambar/QRcode-set-ecat/<?php echo $img ?>" style="width: 115px; height: 125px" >
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div id="content2" style="max-width: 21cm;">
                            <div class="row">
                                <div class="col-9">
                                    ...
                                    <p class="p-2" style="font-weight: bold; font-size: 26px; margin-bottom: 0px !important;"><?php echo $data['nama_set_ecat']; ?></p>
                                    <div class="row p-1">
                                        <div class="col-9 ms-2" style="font-size: 18px;">Kemenkes RI AKL : <?php echo $data['no_izin_edar'] ?></div>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <img src="gambar/QRcode-set-ecat/<?php echo $img ?>" style="width:175px; height:175px" >
                                </div>
                            </div>
                        </div>
                        <br>
