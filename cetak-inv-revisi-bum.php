...
<body>
    ...
    <div class="invoice">
        <div style="text-align: center;">
            ...
            <a href="detail-komplain-revisi-bum.php?id=<?php echo $id_komplain ?>" style="text-decoration: none;" class="print-button-new" id="printButton"><i class="fas fa-arrow-left"></i> Halaman Sebelumnya</a>
            <!-- Elemen Select -->
            <!-- Elemen Select -->
            <?php
            ...
            <table class="invoice-table">
                ...
                <tbody>
                    ...
                    $sql_trx = "SELECT
                                ...
                                WHERE bum.id_inv_bum = '$id_inv' AND trx.status_br_refund = '0'
