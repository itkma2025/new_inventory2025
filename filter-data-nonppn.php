...
<body>
    <div class="table-responsive" id="filteredDataNonPpn">
        ...
        <table class="table table-bordered table-striped" id="filter_nonppn">
            <thead>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center text-nowrap">
                            ...
                            <button data-bs-toggle="modal" data-bs-target="#cancelModal" class="btn btn-danger btn-sm" title="Cancel Order" data-id="<?php echo $data['id_inv_nonppn']; ?>" data-noinv="<?php echo $data['no_inv']; ?>" data-cs="<?php echo $data['nama_cs'] ?>">
