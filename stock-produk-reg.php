        ...
        <div class="card">
          <div class="card-body p-3">
            ...
            <ul class="nav nav-pills mb-3 mt-3">
              ...
              <li class="nav-item">
                <a href="stock-produk-set-reg.php" class="nav-link">Produk Set</a>
              </li>
            </ul>
              ...
              <table class="table table-striped table-bordered" id="tableExport">
                ...
                <tbody>
                  ...
                  while ($data = mysqli_fetch_array($query)) {
                    $id_stock = encrypt($data['id_stock_prod_reg'], $key_global);
                      ...
                      if ($role == "Super Admin" || $role == "Manager Gudang" ) { 
                          ?>
                            <td class="text-center text-nowrap">
                              <a href="proses/proses-stock-reg.php?hapus-stock-reg=<?php echo urlencode($id_stock) ?>&id_produk=<?php echo urlencode($id_produk) ?>" class="btn btn-sm btn-danger delete-data"><i class="bi bi-trash"></i></a>
                            </td>
                          <?php 
                        }
                      ?>
