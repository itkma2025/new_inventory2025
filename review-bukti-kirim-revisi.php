        ...
        <section>
            ...
            <div class="card">
                ...
                <div class="card-body mt-3">
                    ...
                    <div class="p-3">
                        <div class="mb-4">
                            <button type="button" id="review-reg" class="btn btn-outline-primary active" style="width: 150px;">
                                Reguler 
                                <span class="ms-1 badge text-bg-primary" id="badgeReg"></span>
                            </button>
                            <button type="button" id="review-ecat" class="btn btn-outline-primary" style="width: 150px;">
                                Ecat
