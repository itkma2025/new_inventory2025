    ...
    <main id="main" class="main">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="proses/proses-invoice-ppn.php" method="POST" id="myForm">
                        <?php
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-6">
                                ...
                                <input type="hidden" name="id_cb_ppn" value="CB-PPN-<?php echo $year ?><?php echo $month ?><?php echo $uuid ?><?php echo $day ?>">
                                <div class="mt-3">
                                    <label><strong>No Invoice Nonppn</strong></label>
                                    <input type="text" class="form-control" name="no_inv_ppn" value="<?php echo $no_inv ?>" readonly>
                                </div>
                                <div class="mt-3">
                                ...
                                <div class="mt-3">
                                    <div class="row">
                                        <div class="col-sm-6 d-none" id="div_cb_total_inv">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="cb_total_inv" name="cb_total_inv" class="form-control text-end" max="100" readonly>
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 d-none" id="div_cb_pajak">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="cb_pajak" name="cb_pajak" class="form-control text-end" max="100" readonly>
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                                    </div>
