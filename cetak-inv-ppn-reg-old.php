        ...
        <?php
            if ($kwitansi == '1' || $surat_jalan == '1') {
                if ($kwitansi == '1') {
                    ?>
                        <!-- Cetak Kwitansi -->
                        <button id="cetakKwitansi printButton" class="print-button" style="background-color: #FF4500;">
                ...
                if ($surat_jalan == '1') {
                    ?>
                        <!-- Cetak Surat Jalan -->
                        <button id="cetakSuratJalan printButton" class="print-button" style="background-color: #C71585;">
