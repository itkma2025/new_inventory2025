        ...
        <div class="card">
          ...
          <div class="card-body p-3">
            <form action="proses/proses-produk-set-ecat.php" method="post">
              ...
              <input type="hidden" class="form-control" name="id_set_ecat" value="<?php echo $decrypt_id ?>">
              <div class="mb-3">
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="mt-3">
                    ...
                    <a href="detail-isi-set-ecat.php?detail-id=<?php echo $id_set ?>" class="btn btn-secondary btn md"><i class="bi bi-x"></i> Batal</a>
                  </div>
                </div>
              </div>
            </form>
