        ...
        <section>
            ...
            <div class="card">
                <div class="card-body mt-3">
                    ...
                    <div class="p-3">
                        <div class="mb-4">
                            <button type="button" id="sudah-review-reg" class="btn btn-outline-dark active" style="width: 150px;">Reguler</button>
                            <button type="button" id="sudah-review-ecat" class="btn btn-outline-dark" style="width: 150px;">Ecat</button> 
                            <button type="button" id="sudah-review-pl" class="btn btn-outline-dark" style="width: 150px;">Ecat PL</button>
                        </div>
                        <div class="mt-4">
