                        ...
                        <div class="modal-body">
                            <div class="card-body">
                                ...
                                if (file_exists($img)) {
                                    ...
                                    // Mengonversi ukuran file ke kilobytes (KB)
                                    $file_size_kb = round($file_size / 1024, 2);

                                    // Mengonversi ukuran file ke megabytes (MB)
                                    $file_size_mb = round($file_size / 1048576, 2);

                                    // echo "Ukuran file: $file_size bytes ($file_size_kb KB) ($file_size_mb MB)";
                                } else {
                                        ...
                                        <?php if (!empty($gambar1)) : ?>
                                            <div class="carousel-item active">
                                                ...
                                                <div class="text-center mt-3">
                                                    ...
                                                    <h6><?php echo "Ukuran file: $file_size bytes ($file_size_kb KB) ($file_size_mb MB)" ?></h6>
                                                </div>
                                            </div>
                                        <?php endif; ?>
