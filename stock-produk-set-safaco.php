        ...
        <div class="card">
          <div class="card-body p-3">
            ...
            <ul class="nav nav-pills mb-3 mt-3">
              <li class="nav-item">
                <a href="stock-produk-safaco.php" class="nav-link">Produk Satuan</a>
              </li>
              <li class="nav-item" >
            ...
            <div class="table-responsive mt-3">
                ...
                <tbody>
                    ...
                    $sql_set = "SELECT 
                                ...
                                WHERE SUBSTRING(COALESCE(tpr.id_produk_safaco, tpsm.id_set_safaco), 1, 2) = 'SE'
                                ORDER BY nama_produk ASC";
                    $query_set = mysqli_query($connect, $sql_set);
                    while ($data_set = mysqli_fetch_array($query_set)) {
                    $id_stock = encrypt($data_set['id_stock_prod_safaco'], $key_global);
