                    ...
                    <form action="proses/proses-invoice-nonppn.php" method="POST" id="myForm">
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-6">
                                ...
                                <input type="hidden" name="id_cb_nonppn" value="CB-NONPPN-<?php echo $year ?><?php echo $month ?><?php echo $uuid ?><?php echo $day ?>">
                                <div class="mt-3">
                                    <label><strong>No Invoice Nonppn</strong></label>
                                    <input type="text" class="form-control" name="no_inv_nonppn" value="<?php echo $no_inv ?>" readonly>
                                </div>
                                <div class="mt-3">
