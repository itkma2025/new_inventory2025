                                            ...
                                            <table class="table table-bordered table-striped w-100" id="tableNoExportNew">
                                                <thead>
                                                    <tr class="text-white" style="background-color: navy;">
                                                        ...
                                                        <th class="text-center p-3 text-nowrap" style="width: 200px">No. PO</th>
                                                        <th class="text-center p-3 text-nowrap" style="width: 150px">Jenis Invoice</th>
                                                        <th class="text-center p-3 text-nowrap" style="width: 350px">Nama Satker</th>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <?php 
                                                                    echo !empty($data['jenis_inv']) ? $data['jenis_inv'] : '-';
                                                                ?>
                                                            </td>
...
<script>
   $(document).ready(function(){
    ...
    $(document).on('click', '.historyReview', function() {
        ...
        $.ajax({
            url: "ajax/history-bukti-kirim-ecat-pl.php", 
            type: "POST",
            data: { id: id },
