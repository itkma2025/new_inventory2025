                  ...
                  <form action="proses/proses-produk-reg.php" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                      <div class="mb-3">
                        ...
                        $sql = "SELECT 
                                  pr.id_produk_safaco, pr.kode_produk, pr.nama_produk, pr.kode_katalog, pr.satuan, pr.harga_produk, pr.gambar, pr.deskripsi,
                                ...
                                WHERE pr.id_produk_safaco = '$ide'";
                        $result = mysqli_query($connect, $sql);
                        $row = mysqli_fetch_array($result);
                        $img = $row['gambar'];
                        $no_img = $row["gambar"] == "" ? "gambar/upload-produk-safaco/no-image.png" : "gambar/upload-produk-safaco/$img";
                        ?>
                        <div class="mb-3">
                          <label class="form-label"><strong>Kode Produk</strong></label>
                          <input type="hidden" class="form-control" name="id_produk" value="<?php echo $row['id_produk_safaco']; ?>">
                      ...
                      <div class="modal-footer">
                        <button type="submit" name="edit-produk-safaco" id="ubahData" class="btn btn-primary btn-md m-1" onclick="ubahData()"><i class="bx bx-save"></i> Ubah Data</button>
                        <a href="data-produk-safaco.php" class="btn btn-secondary btn-md m-1"><i class="bi bi-x"></i> Tutup</a>
                      </div>
                  </form>
                </div>
              </div>
      ...
      ?>
        ...
        <script>
            ...
            Swal.fire({
                ...
                window.location.href = "data-produk-safaco.php";
            });
            });
        </script>
      <?php
