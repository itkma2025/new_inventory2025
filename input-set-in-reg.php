...
<body>
                    ...
                    <div class="card-body p-3">
                        <form action="tampil-data-set-marwa.php" method="POST">
                            ...
                            <div class="mb-3 text-end">
                                ...
                                <a href="barang-masuk-set-reg.php?date_range=year" class="btn btn-secondary btn-md"><i class="bi bi-x"></i> Tutup</a>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="table table-responsive">
                        <table class="table table-bordered table-striped" id="tableAdd">
                            <thead>
    ...
    <script>
        ...
        $(document).on('click', '#tableAdd tbody tr', function(e) {
