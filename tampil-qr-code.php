    ...
    <main id="main" class="main <?php echo $display ?>">
        <section class="section dashboard">
            <?php  
                ...
                $sql = "SELECT pr.nama_produk, qr.id_produk_qr, qr.url_qr, qr.qr_img, kp.no_izin_edar,  mr.nama_merk
                        ...
                        <div id="content">
                            <div class="row">
                                ...
                                <div class="col-2 text-end">
                                    <img src="gambar/QRcode/<?php echo $img ?>" style="width: 115px; height: 125px" >
                                </div>
                            </div>
                        </div>
                        <br>
