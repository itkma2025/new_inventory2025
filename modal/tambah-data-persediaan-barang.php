...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php
                $csrf_token = ''; // Nilai default untuk menghindari error
                $action = "";
                ...
                <form action="<?php echo $action ?>" method="POST" autocomplete="off">
                    ...
                    <div id="data_out" style="display: none;">
                        ...
                        <div class="mt-3" id="noSpk" style="display: none;">
                            ...
                            <select name="id_spk" id="selectSpk" class="form-select">
                    ...
                    <div id="qtyKet" style="display: none;">
                        <div class="mt-3">
                            ...
                            <input type="text" class="form-control" name="qty" id="qtyResponse" required min="1" autocomplete="off">
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('change', '#selectSpk', function() {
                var selectedValue = $(this).val();
                var id_trx = selectedValue.split(',')[0];

                $.ajax({
                    url: 'ajax/qty-trx.php',
                    type: 'POST',
                    data: { id_trx: id_trx },
                    success: function(response) {
                        // console.log('Server response:', response);
                        // Menampilkan nilai qty di dalam input
                        $('#qtyResponse').val(response.trim()); // Mengisi input dengan ID qtyResponse
                    },
