        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center border-bottom fw-bold fs-5">
                    <label>Edit Data Barang Keluar</label>
                </div>
                <?php
                ...
                <form action="<?php echo $action ?>" method="POST" autocomplete="off">
                    ...
                    date_default_timezone_set('Asia/Jakarta');
                    ?>
                    <input type="hidden" id="csrf_token_editOut" class="form-control" name="csrf_token">
            ...
            $('#editOut').on('show.bs.modal', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#csrf_token_editOut').val(response.token_csrf);
