          ...
          <div class="card-body">
            ...
            <form method="post" action="proses/proses-br-in-import.php" class="form">
              <div class="row">
                ...
                <div class="col-sm-2 mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="harga" id="hargaInput" maxlength="8" disabled>
                  </div>
                </div>
                <div class="col-sm-2 mb-3">
                  <label>Qty</label>
              ...
              <div class="text-end">
                ...
                <a href="tampil-br-import.php?id=<?php echo urlencode($_GET['id']) ?>" class="btn btn-secondary"><i class="bi bi-arrow-left-square-fill" style="color: white; font-size: 18px;"></i> Tutup</a>
              </div>
            </form>
      ...
      <div class="modal-body">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="reguler-tab" data-bs-toggle="pill" data-bs-target="#reguler" type="button" role="tab" aria-controls="reguler" aria-selected="true">Produk Reguler</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="ecat-tab" data-bs-toggle="pill" data-bs-target="#ecat" type="button" role="tab" aria-controls="ecat" aria-selected="false">Produk E-Cat</button>
          </li>
        </ul>
        <div class="tab-content" id="pills-tabContent">
          <div class="tab-pane fade show active" id="reguler" role="tabpanel" aria-labelledby="reguler-tab" tabindex="0">
          ...
          <div class="tab-pane fade" id="ecat" role="tabpanel" aria-labelledby="ecat-tab" tabindex="0">
            <div class="table-responsive">
...
//     // Menghapus semua karakter kecuali angka dan koma
//     this.value = this.value.replace(/[^\d.]/g, '');

//     // Mengubah koma menjadi titik jika terdapat lebih dari satu koma
