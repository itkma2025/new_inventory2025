        ...
        <section class="section dashboard">
            <?php
                ...
                $sql = "SELECT pr.nama_produk, qr.id_produk_qr, qr.qr_img, kp.no_izin_edar,  mr.nama_merk
                        ...
                        WHERE qr.id_produk_qr = '$id_produk'";
            ...
            <?php  
                if ($cek_data > 0) {
                    ...
                    $id_produk_encode = base64_encode($id_produk_qr);
                    $img = $data['qr_img'];
                    $no_img = $data["qr_img"] == "" ? "gambar/QRcode-safaco/no-image.png" : "gambar/QRcode-safaco/$img";
                    ?>
                        <div id="content">
                            <div class="row">
                                <div class="col-10">     
                                    <p class="p-2" style="font-weight: bold; font-size: 26px; margin-bottom: 0px !important;"><?php echo $data['nama_produk']; ?> (<?php echo $data['nama_merk']; ?>) </p>
                                    <div class="row">
                                        <div class="ms-2" style="font-size: 20px;">Kemenkes RI AKL : <?php echo $data['no_izin_edar'] ?></div>
                                    </div>  
                                </div>
                                <div class="col-2 text-end">
                                    <img src="gambar/QRcode-safaco/<?php echo $img ?>" style="width: 115px; height: 125px" >
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="text-center" style="max-width: 22cm;">
                        ...
                        <div id="content2" style="max-width: 21cm;">
                            <div class="row">
                                <div class="col-9">
                                    ...
                                    <p class="p-2" style="font-weight: bold; font-size: 26px; margin-bottom: 0px !important;"><?php echo $data['nama_produk']; ?></p>
                                    <div class="row p-1">
                                ...
                                <div class="col-3">
                                    <img src="gambar/QRcode-safaco/<?php echo $img ?>" style="width:175px; height:175px" >
                                </div>
                            </div>
                        </div>
                        <br>
