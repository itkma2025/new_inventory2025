<?php
    ...
    if (isset($sanitasi_post['simpan'])) {
        ...
        $id_kartu_stock = $sanitasi_post['id_kartu_stock'];
        $id_history = $sanitasi_post['id_history'];
        ...
        $jenis_barang_masuk = $sanitasi_post['jenis_barang_masuk'];
        $jenis_barang_keluar = $sanitasi_post['jenis_barang_keluar'];
        $values_spk = !empty($sanitasi_post['id_spk']) ? $sanitasi_post['id_spk'] : '-';
            ...
            if ($token_csrf != "") {
                if ($date_now > $exp_token) {
                    ...
                    try {
                        ...
                        $simpan_data_kartu_stock = "INSERT INTO kartu_stock_reg 
                        ...
                        $simpan_history_kartu_stock = "INSERT INTO kartu_stock_reg_history
        ...
        if ($token_csrf != "") {
            if ($date_now > $exp_token) {
                ...
                try {
                    ...
                    // Eksekusi query SQL pertama
                    $edit_in = "UPDATE kartu_stock_reg SET keterangan = '$keterangan', qty_in = '$qty' WHERE id_kartu_stock = '$id_kartu_stock_decrypt'";
        ...
        if ($token_csrf != "") {
            if ($date_now > $exp_token) {
                ...
                try {
                    ...
                    // Eksekusi query SQL pertama
                    $edit_out = "UPDATE kartu_stock_reg SET keterangan = '$keterangan', qty_out = '$qty' WHERE id_kartu_stock = '$id_kartu_stock_decrypt'";
        ...
        try {
            ...
            // Eksekusi query SQL pertama
            $hapus = $connect->query("DELETE FROM kartu_stock_reg WHERE id_kartu_stock = '$id_kartu_stock_decrypt'");
            if (!$hapus) {
                throw new Exception("Kesalahan dalam eksekusi simpan data kartu stock: " . $connect->error);
            }
