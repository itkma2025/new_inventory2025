<?php  
    ...
    if($action === 'approval'){
		...
		try {
			...
			$stmt->bind_param('iss', $status_review, $datetime_now, $id_komplain);
			...
			$stmt->bind_param('isss', $approval, $datetime_now, $id_user, $id_komplain);
			...
			$stmt = $connect->prepare("INSERT INTO history_inv_bukti_terima_revisi   
													(id_history, id_bukti_terima, id_komplain, bukti_satu, bukti_dua, bukti_tiga, lokasi, approval, approval_date, approval_by, alasan, created_date, created_by)
										SELECT ?, id_bukti_terima, id_komplain, bukti_satu, bukti_dua, bukti_tiga, lokasi, approval, approval_date, approval_by, alasan, created_date, created_by 
