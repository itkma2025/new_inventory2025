            ...
            <div class="card pe-2">
                ...
                <?php  
                    ...
                    if($jenis_produk == "reguler"){
                        $active_reg = "active";
                        require_once "query/data-kartu-stock-produk-reg.php";
                    } else if($jenis_produk == "ecat"){
                        $active_ecat = "active";
                        require_once "query/data-kartu-stock-produk-ecat.php";
                    } else {
                        ?>
                            <script>
                ...
                <div class="mt-3" style="margin-left: 12px;">
                    <a href="data-kartu-stock-produk-satuan.php?jenis=reguler" class="btn btn-outline-success mobile load-page <?php echo $active_reg ?>"><i class="bi bi-box-seam"></i> Produk Reguler</a>
                    <a href="data-kartu-stock-produk-satuan.php?jenis=ecat" class="btn btn-outline-success mobile load-page <?php echo $active_ecat ?>"><i class="bi bi-box-seam-fill"></i> Produk E-Catalog</a>
                </div>
                <div id="info"></div>
